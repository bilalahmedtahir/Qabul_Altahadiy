...
public class GeneralKnowledgeActivity extends AppCompatActivity {
    private static final String JSON_URL = "https://opentdb.com/api.php?amount=50&category=9&type=multiple";
...
//                                Demo demo = new Demo(demoObject.getString("question"));
    ...
    public void Nextbtn(final View v) {
        next =findViewById(R.id.NextBtnid);
        btn = new Button[]{optionA, optionB, optionC, optionD};

        mp1 = MediaPlayer.create(this, R.raw.heart_beat);
        mp2 = MediaPlayer.create(this, R.raw.airhorn);
...
//                    btnprize[howManyQuestion].setBackgroundColor(Color.RED);
    ...
    public void OptionD(View v) {
        flowers=findViewById(R.id.your_image);
        countDownTimer.cancel();
        next.setEnabled(true);
        mp1.stop();
        ...
        if (optionD.getText().equals(btn[CorrectAnswerposition].getText())) {
            ...
            float bottomOfScreen = getResources().getDisplayMetrics()
                    .heightPixels - (flowers.getHeight() * -5);
